...
@interface WDVideoPlayerController () {
    AVPlayer *_player;
...
@implementation WDVideoPlayerController
...
- (void)configMoviePlayer {
    ...
    [[WDImageManager manager] getPhotoWithAsset:_model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        _cover = photo;
    }];
    [[WDImageManager manager] getVideoWithAsset:_model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
