...
#import "WDPhotoPreviewCell.h"
#import "WDAssetModel.h"
#import "UIView+Layout.h"
#import "WDImagePickerViewController.h"
#import "WDImageManager.h"

@interface WDPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@implementation WDPhotoPreviewController
...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[WDPhotoPreviewCell class] forCellWithReuseIdentifier:@"WDPhotoPreviewCell"];
}

#pragma mark - Click Event

- (void)select:(UIButton *)selectButton {
    WDAssetModel *model = _photoArr[_currentIndex];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WDPhotoPreviewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"WDPhotoPreviewCell" forIndexPath:indexPath];
...
- (void)showPhotoBytes {
    [[WDImageManager manager] getPhotosBytesWithArray:@[_photoArr[_currentIndex]] completion:^(NSString *totalBytes) {
